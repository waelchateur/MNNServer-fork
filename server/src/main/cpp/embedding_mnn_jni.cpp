...
JNIEXPORT jlong JNICALL Java_io_kindbrave_mnn_server_engine_MNNEmbedding_initNative(JNIEnv *env,
                                                                                        jobject thiz,
                                                                                        jstring modelDir,
...
Java_io_kindbrave_mnn_server_engine_MNNEmbedding_updateMaxNewTokensNative(JNIEnv *env, jobject thiz,
                                                                           jlong llm_ptr,
                                                                           jint max_new_tokens) {
...
Java_io_kindbrave_mnn_server_engine_MNNEmbedding_embedding(JNIEnv *env, jobject thiz,
                                                              jlong llm_ptr,
                                                              jstring text) {
    auto *embedding = reinterpret_cast<mls::EmbeddingSession *>(llm_ptr);
...
JNIEXPORT void JNICALL Java_io_kindbrave_mnn_server_engine_MNNEmbedding_releaseNative(JNIEnv* env,
                                                                               jobject thiz,
                                                                               jlong objecPtr) {
