...
JNIEXPORT jlong JNICALL Java_io_kindbrave_mnn_server_engine_MNNAsr_initNative(
        JNIEnv *env,
        jobject thiz,
        jstring configPath) {
...
Java_io_kindbrave_mnn_server_engine_MNNAsr_recognizeFromFileStreamNative(
        JNIEnv *env,
        jobject thiz,
        jlong asr_ptr,
        jstring wavFilePath,
...
JNIEXPORT void JNICALL Java_io_kindbrave_mnn_server_engine_MNNAsr_releaseNative(
        JNIEnv* env,
        jobject thiz,
        jlong asr_ptr) {
